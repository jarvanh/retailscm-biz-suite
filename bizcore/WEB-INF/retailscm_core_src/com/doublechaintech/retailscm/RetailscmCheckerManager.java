...
public class RetailscmCheckerManager extends BaseManagerImpl {
	...
	public com.doublechaintech.retailscm.objectaccess.ObjectAccessManager objectAccessManagerOf(RetailscmUserContext userContext){
		return userContext.getManagerGroup().getObjectAccessManager();
	}
	public com.doublechaintech.retailscm.objectaccess.ObjectAccessDAO objectAccessDaoOf(RetailscmUserContext userContext){
	...
	public com.doublechaintech.retailscm.genericform.GenericFormManager genericFormManagerOf(RetailscmUserContext userContext){
		return userContext.getManagerGroup().getGenericFormManager();
	}
	public com.doublechaintech.retailscm.genericform.GenericFormDAO genericFormDaoOf(RetailscmUserContext userContext){
		return userContext.getDAOGroup().getGenericFormDAO();
	}
	public com.doublechaintech.retailscm.formmessage.FormMessageManager formMessageManagerOf(RetailscmUserContext userContext){
		return userContext.getManagerGroup().getFormMessageManager();
	}
	public com.doublechaintech.retailscm.formmessage.FormMessageDAO formMessageDaoOf(RetailscmUserContext userContext){
		return userContext.getDAOGroup().getFormMessageDAO();
	}
	public com.doublechaintech.retailscm.formfieldmessage.FormFieldMessageManager formFieldMessageManagerOf(RetailscmUserContext userContext){
		return userContext.getManagerGroup().getFormFieldMessageManager();
	}
	public com.doublechaintech.retailscm.formfieldmessage.FormFieldMessageDAO formFieldMessageDaoOf(RetailscmUserContext userContext){
		return userContext.getDAOGroup().getFormFieldMessageDAO();
	}
	public com.doublechaintech.retailscm.formfield.FormFieldManager formFieldManagerOf(RetailscmUserContext userContext){
		return userContext.getManagerGroup().getFormFieldManager();
	}
	public com.doublechaintech.retailscm.formfield.FormFieldDAO formFieldDaoOf(RetailscmUserContext userContext){
		return userContext.getDAOGroup().getFormFieldDAO();
	}
	public com.doublechaintech.retailscm.formaction.FormActionManager formActionManagerOf(RetailscmUserContext userContext){
		return userContext.getManagerGroup().getFormActionManager();
	}
	public com.doublechaintech.retailscm.formaction.FormActionDAO formActionDaoOf(RetailscmUserContext userContext){
