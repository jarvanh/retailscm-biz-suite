...
public class ObjectAccessManagerImpl extends CustomRetailscmCheckerManager implements ObjectAccessManager, BusinessHandler{
 ...
 //--------------------------------------------------------------
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(RetailscmUserContext userContext,SmartList<ObjectAccess> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(RetailscmUserContext userContext, String objectAccessId) throws Exception{
	  SerializeScope vscope = RetailscmViewScope.getInstance().getObjectAccessDetailScope().clone();
