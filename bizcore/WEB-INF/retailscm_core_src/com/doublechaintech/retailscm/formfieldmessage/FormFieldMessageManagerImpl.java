...
public class FormFieldMessageManagerImpl extends CustomRetailscmCheckerManager implements FormFieldMessageManager, BusinessHandler{
 ...
 //--------------------------------------------------------------
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(RetailscmUserContext userContext,SmartList<FormFieldMessage> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<GenericForm> formList = RetailscmBaseUtils.collectReferencedObjectWithType(userContext, list, GenericForm.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(RetailscmUserContext userContext, String formFieldMessageId) throws Exception{
	  SerializeScope vscope = RetailscmViewScope.getInstance().getFormFieldMessageDetailScope().clone();
