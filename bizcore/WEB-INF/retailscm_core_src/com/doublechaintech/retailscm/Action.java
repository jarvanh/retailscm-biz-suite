...
class BaseAction {
	...
	public BaseAction withActionName(String name){
		this.setActionName(name);
		return this;
		
	}
	public BaseAction withManagerBeanName(String managerBeanName){
		this.setManagerBeanName(managerBeanName);
		return this;
		
	}
	public BaseAction withActionPath(String actionPath){
		this.setActionPath(actionPath);
		return this;
	}
	public BaseAction withActionKey(String actionKey){
		this.setActionKey(actionKey);
		return this;
	}
	public BaseAction withLocaleKey(String localeKey){
		this.setLocaleKey(localeKey);
		return this;
	}
	public BaseAction withActionGroup(String actionGroup){
		this.setActionGroup(actionGroup);
		return this;
	}
	public BaseAction withActionLevel(String actionLevel){
