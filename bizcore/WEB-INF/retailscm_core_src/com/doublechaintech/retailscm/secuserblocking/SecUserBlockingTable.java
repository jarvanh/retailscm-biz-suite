...
public class SecUserBlockingTable{
	...
	public static final String []ALL_CLOUMNS = {COLUMN_ID,COLUMN_WHO,COLUMN_BLOCK_TIME,COLUMN_COMMENTS,COLUMN_VERSION};
	public static final String []NORMAL_CLOUMNS = {COLUMN_WHO,COLUMN_BLOCK_TIME,COLUMN_COMMENTS};
