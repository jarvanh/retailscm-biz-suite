...
public class FormActionManagerImpl extends CustomRetailscmCheckerManager implements FormActionManager, BusinessHandler{
 ...
 //--------------------------------------------------------------
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(RetailscmUserContext userContext,SmartList<FormAction> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(RetailscmUserContext userContext, String formActionId) throws Exception{
	  SerializeScope vscope = RetailscmViewScope.getInstance().getFormActionDetailScope().clone();
